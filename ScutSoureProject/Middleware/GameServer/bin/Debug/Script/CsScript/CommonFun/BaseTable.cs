...
namespace GameServer.Script.CsScript.Action
{
    ...
    public class BaseTable
    {
        ...
        public int GetRobotCount()
        {
            ...
            ForeashAllDoBase((i) =>
            {
                if (_pos2userbase[i]._isRobot) _robot++;
            });
            return _robot;
        }
        /// <summary>
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public BaseUser GetBaseUserByPos(int pos)
        {
            BaseUser _tempUser;
            _pos2userbase.TryGetValue(pos, out _tempUser);
            if (_tempUser == null) ErrorRecord.Record("201704041430bf fetal Error 必需处理   pos:" + pos);
            return _tempUser;
        }
        /// <summary>
        ...
        protected bool HaveSomeBodyUnDeal()
        {
            ...
            {
                BaseUser _buser;
                if (!_pos2userbase.TryGetValue(i, out _buser))
                {
                    ErrorRecord.Record("BaseTable fetal error 201611101102   ..................................***");
                    return;
                }

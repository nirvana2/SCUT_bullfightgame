...
namespace GameServer.Script.CsScript.Action
{
    ...
    /// 
    /// </summary>
    public class BFColorSendDataServer : BaseSendDataServer 
    {
        private static BFColorSendDataServer _ins;
        public static BFColorSendDataServer instance
        {
            get
            {
                if (_ins == null) _ins = new BFColorSendDataServer();
                return _ins;
            }
        }
        public BFColorSendDataServer()
        {
        ...
        /// 机器人处理的线程
        /// </summary>
        private  WaitCallback callBack = new WaitCallback(BullColorRobot.RobotDealMSG);
